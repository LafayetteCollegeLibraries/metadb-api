  ...
  describe '.new' do
    ...
    context 'using an existing MetaDB Item' do
      ...
      it 'creates a new Item from a MetaDB record' do
        ...
        @item = Item.new(project, 3, '0003', [ @field ])
    ...
    context 'using an existing file path' do
      ...
      it 'creates a new Item from an image in the TIFF' do
        ...
        @item = Item.new project, file_path: File.join(File.dirname(__FILE__), 'fixtures', 'lc-spcol-test-project-0003.tif')
      ...
      it 'creates a new Item from an image in the JPEG format' do
        ...
        @item = Item.new project, file_path: test_file_path
      ...
      it 'raises exceptions for improperly structured file names' do
        ...
        expect { @item = Item.new project, file_path: test_file_path }.to raise_error("Failed to parse the master image file path #{test_file_path}")
      end
    end
  end
